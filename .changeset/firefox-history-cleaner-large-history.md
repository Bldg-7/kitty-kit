...
- The popup now shows a breakdown of the last run (entries found older than the cutoff, whitelisted, failed, and the first failure message) so "Deleted: 0" can be explained instead of guessed at.
